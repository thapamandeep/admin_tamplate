 ...
 <section class="py-3" style="background-image: url('{{asset('assets/gallery/background-pattern.jpg')}}');background-repeat: no-repeat;background-size: cover;">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
                ...
                <div class="swiper main-swiper">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          ...
                          <div class="categories my-3">Neplease Product</div>

                          
                          <h3 class="display-4"> Rara Noodles</h3>
                          <p></p>
                        ...
                        <div class="img-wrapper col-md-5">
                          ...
                          <img src="{{asset('assets/img/women5.png')}}" class="img-fluid" style="height:440px;width:440px">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        <div class="content-wrapper col-md-7">
                          <div class="categories mb-3 pb-3">Nepali Product</div>
                          <h3 class="banner-title">Wai Wai Noodles</h3>
                          <p></p>
                          <a href="#" class="btn btn-outline-dark btn-lg text-uppercase fs-6 rounded-1">Shop Collection</a>
                        </div>
                        <div class="img-wrapper col-md-5">
                          <img src="{{asset('storage/gallery/1770392224.png')}}" class="img-fluid">
                        </div>
                      </div>
                    </div>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('{{asset('storage/gallery/chocolate1.png')}}') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">

                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">20% off</div>
                    <h3 class="banner-title">Chocolate</h3>
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('{{asset('storage/gallery/coffee6.png')}}') no-repeat;background-position: right bottom;">
                <div class="row banner-content p-5">

                  <div class="content-wrapper col-md-7">
                    <div class="categories sale mb-3 pb-3">16% off</div>
    ...
    <section class="py-5 overflow-hidden">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770457969.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Bambino Spageeti</p>
                          <h5 class="card-title">Japnese product</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770458250.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Pran litchi Juice</p>
                          <h5 class="card-title">Pure and healthy</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770460962.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Golden Oak</p>
                          <h5 class="card-title">Liquar item</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770463599.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Afzal Hukka flvr</p>
                          <h5 class="card-title">Liquar item</h5>
                        </div>
                      </div>
                    </div>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770462290.jpeg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Mamypyako Pants</p>
                ...
                <div class="swiper-slide">
                  <div class="card mb-3 p-3 rounded-4 shadow border-0">
                    <div class="row g-0">
                      <div class="col-md-4">
                        <img src="{{asset('storage/gallery/1770463695.jpg')}}" class="img-fluid rounded" alt="Card title">
                      </div>
                      <div class="col-md-8">
                        <div class="card-body py-0">
                          <p class="text-muted mb-0">Bounty Chocolate</p>
                          <h5 class="card-title">Chocolate items</h5>
                        </div>
                      </div>
                    </div>
                  </div>
     ...
     <section class="py-5">
      ...
      <div class="row">
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-danger mb-3" style="background: url('{{asset('assets/img/dairy-6.png')}}');background-repeat: no-repeat;background-position: right bottom;">
              <div class="banner-content p-5">

                <div class="categories text-primary fs-3 fw-bold">Upto 25% Off</div>
                <h3 class="banner-title">Dairy Milk Chocolate</h3>
                <p>Very tasty & creamy Chocolate Almond flavour creamy muffins.</p>
          ...
          <div class="col-md-6">
            <div class="banner-ad bg-info" style="background: url('{{asset('assets/img/peanut-butter2.png')}}');background-repeat: no-repeat;background-position: right bottom;">
              <div class="banner-content p-5">

                <div class="categories text-primary fs-3 fw-bold">Upto 25% Off</div>
                <h3 class="banner-title"> Cruncy Peanuts</h3>
      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="{{asset('storage/gallery/phone.png')}}" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
